    ...
    <div class="flex justify-center w-screen overflow-hidden">
      <div class="relative"
        ...
        <div class="absolute z-10 backdrop-blur-sm relative"
          ...
          <!-- Scores -->
          <span id="score1" class="absolute top-[5%] left-[25%] text-[1.5vw]">0</span>
          <span id="score2" class="absolute top-[5%] right-[25%] text-[1.5vw]">0</span>

          <!-- Paddles -->
          <div id="paddle1" class="absolute h-[25%] w-[3.3%] bg-white/90 top-[37.5%] left-0"></div>
          <div id="paddle2" class="absolute h-[25%] w-[3.3%] bg-white/90 top-[37.5%] right-0"></div>

          <!-- Ball -->
          <div id="ball" class="absolute h-[5%] w-[3.3%] bg-white/90 rounded-[30%] left-[48.3%] top-[47.5%]"></div>
...
export function initRemoteGame(roomId: string) {
  ...
  // Listen for server updates AFTER DOM is mounted
...
function updateGameState(state: any) {
  ...
  // Expect state values to be percentages (0–100)
