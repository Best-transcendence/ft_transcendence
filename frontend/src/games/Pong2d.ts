...
<!-- Arcade image anchor -->
			<img src="/assets/machine_tina_transparent(2).png"
...
/* 	<div class="flex items-center justify-center h-screen w-screen overflow-hidden">
		<div class="relative" style="width: 70vw; max-width: 2000px; aspect-ratio: 16/9;">
			<img src="/assets/machine_tina_transparent.png"
				class="absolute inset-0 w-full h-full object-contain"
				alt="Arcade machine" />
				<div class="gameArea absolute inset-0 flex items-center justify-center">
				</div>
		</div>
	</div> */
